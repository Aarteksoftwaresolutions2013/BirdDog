...
<body>
  ...
  <div class="col-sm-6" style="border: solid 1px #BDBDBD;border-radius: 8px;padding: 31px; float:none;margin:0 auto;">
    <form:form method="POST" action="birddogChangePassword"
      ...
      <div class="col-sm-9">
        <form:input path="oldPassword" class="form-control validate[required] input-text" maxlength="30" id="name" placeholder="Enter old password"/>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <form:input path="newPassword" class="form-control validate[required] input-text" maxlength="30" id="email" placeholder="Enter new password"/>
