			...
			<div
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title">${superAdmin.name}</h3>
					</div>
							...
							<div class=" col-md-9 col-lg-9 ">
								<table class="table table-user-information">
									<tbody>
										...
										<tr>
											<td>Address1</td>
											<td>${superAdmin.address.address1}</td>
										</tr>
										<tr>
											<td>Address2</td>
											<td>${superAdmin.address.address2}</td>
										</tr>
										<tr>
											<td>State</td>
											<td>${superAdmin.address.city.county.state.stateName}</td>
										</tr>
										<tr>
											<td>County</td>
											<td>${superAdmin.address.city.county.countyName}</td>
										</tr>
										<tr>
											<td>City</td>
											<td>${superAdmin.address.city.cityName}</td>
										</tr>

										<tr>
											<td>Zip Code</td>
											<td>${superAdmin.address.zipCode}</td>
										</tr>
					...
					<div class="panel-footer">
						<a data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary"><i
							...
							href="superAdminProfile?superAdminId=${superAdmin.id}" data-original-title="Edit this user" data-toggle="tooltip"
							type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a> <a href="welcome"
