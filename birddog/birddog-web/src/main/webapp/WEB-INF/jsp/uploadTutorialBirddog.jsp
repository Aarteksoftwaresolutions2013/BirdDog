...
<body>
		...
		<form:form method="POST" action="saveTutorialBirddog" class="form-horizontal" role="form"
								...
								<div class="form-group">
										...
										<div class="col-lg-8">
												<form:textarea path="description" class="form-control validate[required] input-text"
														value="" type="text" style="height:114px;" maxlength="500"/>
      ...
      <display:table name="tutorialList" pagesize="10" class="table" uid="tutorialList" requestURI="uploadTutorialBirddog">
        <c:set var="count" value="${count+1}" scope="page" />
        <display:column title="S.NO" style="width:1%;">
     ${count}
    </display:column>
        <display:column title="TITLE" >
       <a href="viewSingleTutorialBirddog?tutorialId=${tutorialList.id}">${tutorialList.title}</a>
        </display:column>
        <display:column title="UPDATE">
          <a href="updateSuperAdminTutorialBirddog?tutorialId=${tutorialList.id}&roleId=2&type=default">Update</a></td>
        </display:column>
        <display:column title="Delete">
         <a href="deleteSuperAdminTutorialBirddog?tutorialId=${tutorialList.id}&roleId=2&type=default"
