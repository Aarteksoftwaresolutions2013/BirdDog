...
<body>
  ...
  <form:form method="POST" action="superAdminChangePassword"
      ...
      <div class="col-sm-9">
        <form:input path="oldPassword" class="form-control validate[required] input-text" id="name" placeholder="Enter old password"/>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <form:input path="newPassword" class="form-control validate[required] input-text" id="email" placeholder="Enter new password"/>
