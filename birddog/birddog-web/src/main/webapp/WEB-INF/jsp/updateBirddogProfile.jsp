...
<body>
	<form:form action="saveBirddogProfile" class="form-horizontal"
					role="form" modelAttribute="birddog" enctype="multipart/form-data" onsubmit="return jQuery(this).validationEngine('validate');">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="text-center">
					...
					<input type="file" name="file" class="text-center center-block well well-sm" accept="image/*" onchange="loadFile(event)">
				</div>
			</div>
			<!-- edit form column -->
			<div class="col-md-8 col-sm-6 col-xs-12 personal-info">
				...
				<h3><A>Personal info</A></h3>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<form:input path="email" id="email" class="form-control validate[required] input-text" disabled="true"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<form:input path="address.address1" class="form-control" value=""
								type="text" />
						</div>
					</div>
					<div class="form-group">
							...
							<div class="ui-select">
								<select id="stateId" class="form-control validate[funcCall[ifStateNotSelected]]">
									...
									<c:forEach var="state" items="${states}">
										<c:choose>
											<c:when
												test="${state.id==birddog.address.city.county.state.id}">
							...
							<div class="ui-select">
								...
								<option value="0">Your Location</option>
									<c:forEach items="${counties}" var="county">
										<c:choose>
											<c:when test="${county.id==birddog.address.city.county.id}">
							...
							<div class="ui-select">
								<select name="address.city.id" id="cityId" class="form-control validate[funcCall[ifCityNotSelected]]">
									...
									<c:forEach items="${cities}" var="city">
										<c:choose>
											<c:when test="${city.id==birddog.address.city.id}">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<span></span><a href="cancel"><input  class="btn btn-default" value="Cancel"
								type=""></a>
