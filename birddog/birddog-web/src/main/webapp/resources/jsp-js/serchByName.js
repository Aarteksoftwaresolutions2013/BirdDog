function searchByBirddog() {   
	 var search =document.getElementById("search").value;  
	 if(search==""){
		  document.getElementById("birddog").innerHTML = "please insert the value";
		  return false;
	 }else{
	$.ajax({
		url : "searchByBirddogOnMap?search=" + search,
		type : 'POST',
		dataType : 'json',
...
function searchByCity() {   
	 ...
	 alert(search);
	$.ajax({
		url : "searchByCityOnMap?cityId=" + cityId,
		type : 'POST',
		dataType : 'json',
		contentType : 'application/json',
		mimeType : 'application/json',
