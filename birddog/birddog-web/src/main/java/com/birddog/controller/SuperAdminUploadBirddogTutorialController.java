...
@Controller
public class SuperAdminUploadBirddogTutorialController {

	@Autowired
	private SuperAdminUploadTutorialService superAdminUploadTutorialService;

	@RequestMapping(value = ConstantURL.UPLOAD_TUTORIAL_BIRDDOG_URL, method = { RequestMethod.GET })
	public String uploadTutorial(@ModelAttribute("UploadTutorial") UploadTutorial uploadTutorial, ModelMap model,
		...
		return IConstant.UPLOAD_TUTORIAL_BIRDDOG;
	}

	@RequestMapping(value = ConstantURL.SAVE_TUTORIAL_BIRDDOG_URL, method = { RequestMethod.GET, RequestMethod.POST })
	private String saveTutorial(@ModelAttribute("UploadTutorial") UploadTutorial uploadTutorial, ModelMap model) {
		...
		return "redirect:" + ConstantURL.UPLOAD_TUTORIAL_BIRDDOG_URL;
	}

	@RequestMapping(value = ConstantURL.UPDATE_SUPER_ADMIN_TUTORIAL_BIRDDOG_URL, method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value = ConstantURL.DELETE_SUPER_ADMIN_TUTORIAL_BIRDDOG_URL, method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value = ConstantURL.VIEW_SINGLE_TUTORIAL_BIRDDOG_URL, method = { RequestMethod.GET, RequestMethod.POST })
	private String viewSingleTutorialRei( ModelMap model,@RequestParam(required = false) Integer tutorialId,Integer roleId,String type,String message) {
		...
		return IConstant.VIEW_SINGLE_TUTORIAL_BIRDDOG;
	}
