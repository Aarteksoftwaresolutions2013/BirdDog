...
@Controller
public class ReInvestorUploadBirddogTutorialController {

	@Autowired
	private SuperAdminUploadTutorialService superAdminUploadTutorialService;


	@RequestMapping(value = ConstantURL.UPLOAD_TUTORIAL_BIRDDOG_BY_REI_URL, method = { RequestMethod.GET })
	public String uploadTutorial(@ModelAttribute("UploadTutorial") UploadTutorial uploadTutorial, ModelMap model,
		...
		return IConstant.UPLOAD_TUTORIAL_BIRDDOG_BY_REI;
	}

	@RequestMapping(value = ConstantURL.SAVE_TUTORIAL_BIRDDOG_BY_REI_URL, method = { RequestMethod.GET, RequestMethod.POST })
	private String saveTutorial(@ModelAttribute("UploadTutorial") UploadTutorial uploadTutorial, ModelMap model) {
		...
		return "redirect:" + ConstantURL.UPLOAD_TUTORIAL_BIRDDOG_BY_REI_URL;
	}

	@RequestMapping(value = ConstantURL.UPDATE_TUTORIAL_BIRDDOG_BY_REI_URL, method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value = ConstantURL.DELETE_TUTORIAL_BIRDDOG_BY_REI_URL, method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value = ConstantURL.VIEW_SINGLE_TUTORIAL_BIRDDOG_BY_REI_URL, method = { RequestMethod.GET, RequestMethod.POST })
	private String viewSingleTutorialRei( ModelMap model,@RequestParam(required = false) Integer tutorialId,Integer roleId,String type,String message) {
		...
		return IConstant.VIEW_SINGLE_TUTORIAL_BIRDDOG_BY_REI;
	}
	
	@RequestMapping(value = ConstantURL.VIEW_REI_TUTORIAL_BY_SUPER_ADMIN_URL, method = { RequestMethod.GET })
	public String viewReiTutorialBySuperAdmin(ModelMap model,@RequestParam(required = false) Integer roleId, String type) {
		List<UploadTutorial> tutorialList = superAdminUploadTutorialService.getAllTutorial(roleId, type);
		model.addAttribute("tutorialList", tutorialList);
		return IConstant.VIEW_REI_TUTORIAL_BY_SUPER_ADMIN;
	}
